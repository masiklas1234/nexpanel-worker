...
class _SellerPageState extends State<SellerPage> {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(Uri.parse('$apiBaseUrl/listUsers?key=${widget.keyToken}'));
  ...
  Future<void> _deleteUser() async {
    ...
    setState(() => isLoading = true);
    try {
      final res = await http.get(Uri.parse('$apiBaseUrl/deleteUser?key=${widget.keyToken}&username=$username'));
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    setState(() => isLoading = true);
    try {
      final url = Uri.parse('$apiBaseUrl/createAccount?key=${widget.keyToken}&newUser=$u&pass=$p&day=$d');
      final res = await http.get(url);
      final data = jsonDecode(res.body);
      if (data['created'] == true) {
        _alert("Sukses", "Akun MEMBER berhasil dibuat.");
  ...
  Future<void> _editUser() async {
    ...
    setState(() => isLoading = true);
    try {
      final url = Uri.parse('$apiBaseUrl/editUser?key=${widget.keyToken}&username=$u&addDays=$d');
      final res = await http.get(url);
      final data = jsonDecode(res.body);
      if (data['edited'] == true) {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text("CREATE MEMBER", style: TextStyle(color: primaryWhite, fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Orbitron')),
                  ...
                  _buildInput(label: "Durasi (Max 30 Hari)", controller: createDayController, icon: FontAwesomeIcons.calendarDay, type: TextInputType.number),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInput(label: "Tambah Hari (Max 30)", controller: editDayController, icon: FontAwesomeIcons.calendarPlus, type: TextInputType.number),
                const SizedBox(height: 8),
                SizedBox(
                  width: double.infinity,
                  height: 50,
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Icon(Icons.storefront, color: accentPurple, size: 36),
                    ...
                    if (filteredList.isEmpty && !isLoading)
                      Center(
                        child: Padding(
                          ...
                          child: Text("Belum ada member.", style: TextStyle(color: textGrey)),
                        ),
                      ),
