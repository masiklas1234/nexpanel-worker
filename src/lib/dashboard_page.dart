                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    const Icon(Icons.person_pin, color: accentWhite, size: 14),
                                    const SizedBox(width: 6),
                                    Text("UID: $uid", style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold, fontFamily: 'ShareTechMono')),
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: const Icon(Icons.copy_rounded, color: accentWhite, size: 14),
                                      ),
                                    ),
                                  ],
                                ),
            ...
            child: ClipRRect(
              ...
              child: BottomNavigationBar(
                ...
                items: const [
                  ...
                  BottomNavigationBarItem(icon: Icon(Icons.phone_android_outlined), activeIcon: Icon(Icons.phone_android), label: "RAT"),
